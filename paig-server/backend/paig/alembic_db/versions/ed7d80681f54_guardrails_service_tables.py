"""guardrail_service_tables

Revision ID: ed7d80681f54
Revises: 5e805b526efa
Create Date: 2024-10-16 15:42:34.724684
    ...
    connection.execute(
        sa.text("""
            ...
            SELECT 
                ...
                GROUP_CONCAT(DISTINCT gr_app.application_id) AS application_ids
            FROM
                guardrail gr
