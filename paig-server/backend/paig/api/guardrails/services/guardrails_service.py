...
class GuardrailService(BaseController[GuardrailModel, GuardrailView]):
    ...
    async def create(self, request: GuardrailView) -> GuardrailView:
        ...
        guardrail_model.set_attribute(request.model_dump(exclude_unset=True, exclude={"create_time", "update_time", "version"}, mode="json"))
        ...
        if request.guardrail_connection_name is not None and request.guardrail_provider is not None:
            ...
            guardrail_configs_to_create = GuardrailTransformer.transform(request.guardrail_provider, request.guardrail_configs)

            # Create Guardrails in end service and update the response in guardrail
            guardrail_response = await self._create_guardrail_to_external_provider(guardrail, guardrail_connections, guardrail_configs_to_create)
            guardrail.guardrail_provider_response = guardrail_response
            await self.repository.update_record(guardrail)
    ...
    async def get_by_id(self, id: int, extended: bool) -> GuardrailView:
        ...
        # for gr_conf in guardrail.guardrail_configs:
        #     gr_config = GRConfigView.model_validate(gr_conf)
    ...
    async def update(self, id: int, request: GuardrailView) -> GuardrailView:
        ...
        guardrail_response = await self._update_guardrail_providers(request, guardrail_view, existing_guardrail)
    ...
    async def _update_guardrail_providers(self, request: GuardrailView, guardrail: GuardrailView, existing_guardrail: GuardrailView):
        guardrail_response = {}
        ...
        if request.guardrail_provider is not None and request.guardrail_connection_name is not None:
            new_guardrails_configs = GuardrailTransformer.transform(request.guardrail_provider, request.guardrail_configs)
        ...
        if existing_guardrail.guardrail_provider is not None and existing_guardrail.guardrail_connection_name is not None:
            existing_guardrail_configs = GuardrailTransformer.transform(existing_guardrail.guardrail_provider, existing_guardrail.guardrail_configs)
        ...
        if gr_connections_to_delete and existing_guardrail_configs:
            await self._delete_guardrail_to_external_provider(
                guardrail, gr_connections_to_delete, existing_guardrail_configs, existing_guardrail.guardrail_provider_response)
        ...
        if gr_connections_to_update:
            gr_resp_data = await self._update_guardrail_to_external_provider(
                guardrail, gr_connections_to_update, new_guardrails_configs, existing_guardrail.guardrail_provider_response)
            guardrail_response.update(gr_resp_data)
    ...
    async def delete(self, id: int):
        ...
        if guardrail.guardrail_provider is not None and guardrail.guardrail_connection_name is not None:
            guardrail_configs_to_delete = GuardrailTransformer.transform(guardrail.guardrail_provider, guardrail.guardrail_configs)
            ...
            await self._delete_guardrail_to_external_provider(guardrail, connections_to_delete_guardrails,
                                                              guardrail_configs_to_delete, guardrail_model.guardrail_provider_response)
