...
class AIAppController:
    ...
    async def create_ai_application(self, request: AIApplicationView) -> AIApplicationView:
        ...
        asyncio.create_task(capture_event_on_action(event=CreateAIApplicationEvent()))
        return created_app
    ...
    async def update_ai_application(self, id: int, request: AIApplicationView) -> AIApplicationView:
        ...
        asyncio.create_task(capture_event_on_action(event=UpdateAIApplicationEvent()))
        return updated_app
    ...
    async def delete_ai_application(self, id: int):
        ...
        asyncio.create_task(capture_event_on_action(event=DeleteAIApplicationEvent()))
