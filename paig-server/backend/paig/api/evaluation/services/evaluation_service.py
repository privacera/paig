...
def threaded_run_evaluation(evaluation_config, categories, static_prompts):
    async def async_operations():
        ...
        try:
            ...
            update_eval_params['config'] = str(generated_prompts_config)
...
class EvaluationService:
    ...
    async def run_evaluation(self, evaluation_config, categories, static_prompts):
        ...
        update_eval_params = {
            "status": "GENERATING",
            "custom_prompts": str(static_prompts),
    ...
    async def delete_evaluation(self, id: int):
        """
        ...
        """
        await self.evaluation_repository.delete_evaluation(id)
