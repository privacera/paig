...
from src.privacera_shield_common.async_http_transport import AsyncHttpTransport

@pytest.mark.asyncio
@patch('src.privacera_shield_common.async_http_transport.AsyncHttpTransport.create_default_client')
