...
class TestOpenai(unittest.TestCase):
    ...
    def test_ask_prompt_with_temperature(self, mock_execute_prompt):
        ...
        answer = self.openai_instance.ask_prompt(question, temperature=temperature)

        self.assertIsNotNone(answer)

        answer = self.openai_instance.ask_prompt(question, conversation_messages=conversation_messages, temperature=temperature)
    ...
    def test_ask_prompt_without_temperature(self, mock_execute_prompt):
        ...
        answer = self.openai_instance.ask_prompt(question)
